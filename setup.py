...
def get_version(*file_paths):
    """Retrieves the version from disable_cache_headers/__init__.py"""
...
version = get_version("disable_cache_headers", "__init__.py")
...
setup(
    ...
    version=version,
    description="""Middleware that disables caching headers in Django""",
